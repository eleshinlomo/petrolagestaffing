...
const Hero = () => {
  const [message, setMessage] = useState('Explore opportunities in Nigeria');
  ...
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-gradient-to-b from-blue-50 to-white pt-32 pb-20 dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800"
      > 
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <h1 className="mb-6 text-4xl font-bold leading-tight text-blue-800 dark:text-blue-100 sm:text-5xl sm:leading-tight md:text-6xl md:leading-tight">
                  Nigeria&apos;s Premier <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Staffing Partner</span>
                </h1>
                
                <p className="mb-10 text-lg leading-relaxed text-gray-600 dark:text-gray-300 md:text-xl">
                  Registered in 2015 (RC 1275201), we&apos;ve successfully placed over <span className="font-semibold text-blue-600 dark:text-blue-400">2,000 professionals</span> across leading sectors in Nigeria. 
                  We serve as a strategic partner to both public and private organizations nationwide.
                </p>
                
                <div className="mb-8 rounded-lg bg-blue-50 p-4 text-blue-700 shadow-inner dark:bg-blue-900/20 dark:text-blue-200">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-6 sm:space-y-0">
                  <button
                    ...
                    className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-blue-600 to-cyan-500 px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:to-cyan-400"
                  >
                    <span className="relative z-10">🚀 POST JOBS</span>
                    <span className="absolute inset-0 bg-gradient-to-r from-blue-700 to-cyan-600 opacity-0 transition-all duration-300 group-hover:opacity-100"></span>
                  </button>
                  
                  <Link
                    href="/jobpage"
                    className="group relative overflow-hidden rounded-lg border-2 border-blue-600 bg-transparent px-8 py-4 font-semibold text-blue-600 shadow-lg transition-all duration-300 hover:bg-blue-600 hover:text-white dark:border-blue-400 dark:text-blue-300 dark:hover:bg-blue-900/50"
                  >
                    <span className="relative z-10">🔍 FIND JOBS</span>
                    <span className="absolute inset-0 bg-blue-600 opacity-0 transition-all duration-300 group-hover:opacity-10"></span>
                  </Link>
                </div>
              </div>
            </div>
